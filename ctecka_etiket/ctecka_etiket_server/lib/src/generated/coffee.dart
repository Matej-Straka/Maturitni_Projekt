...
class CoffeeUpdateTable extends _i1.UpdateTable<CoffeeTable> {
  CoffeeUpdateTable(super.table);
  ...
  _i1.ColumnValue<String, String> composition(String value) => _i1.ColumnValue(
    table.composition,
    value,
  );

  _i1.ColumnValue<String, String> moreInfo(String value) => _i1.ColumnValue(
    table.moreInfo,
    value,
  );
...
class CoffeeTable extends _i1.Table<int?> {
  CoffeeTable({super.tableRelation}) : super(tableName: 'coffee') {
    updateTable = CoffeeUpdateTable(this);
  ...
  late final CoffeeUpdateTable updateTable;
...
class CoffeeRepository {
  ...
  /// Updates a single [Coffee] by its [id] with the specified [columnValues].
  /// Returns the updated row or null if no row with the given id exists.
  Future<Coffee?> updateById(
    _i1.Session session,
    int id, {
    required _i1.ColumnValueListBuilder<CoffeeUpdateTable> columnValues,
    _i1.Transaction? transaction,
  }) async {
    return session.db.updateById<Coffee>(
      id,
      columnValues: columnValues(Coffee.t.updateTable),
      transaction: transaction,
    );
  }

  /// Updates all [Coffee]s matching the [where] expression with the specified [columnValues].
  /// Returns the list of updated rows.
  Future<List<Coffee>> updateWhere(
    _i1.Session session, {
    required _i1.ColumnValueListBuilder<CoffeeUpdateTable> columnValues,
    ...
    return session.db.updateWhere<Coffee>(
      columnValues: columnValues(Coffee.t.updateTable),
